...
def plot_moving_average(
    ...
    This function creates a line chart showing the historical closing price of a stock
    and one or more pre-calculated moving averages. 
    Moving averages help smooth short-term price fluctuations 
    and highlight underlying price trends.
